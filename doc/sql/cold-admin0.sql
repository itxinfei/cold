...
CREATE TABLE `cz_message`  (
  `meterCode` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '设备编码',
  ...
  INDEX `idx_metercode`(`meterCode`) USING BTREE,
  INDEX `idx_meterid`(`meterId`) USING BTREE,
  INDEX `idx_hostid`(`hostId`) USING BTREE,
...
-- ----------------------------
INSERT INTO `cz_message` VALUES ('M101001002', '10f9b41b-6d9f-4b10-93ea-47aca273fd39', 'M101001002', '24edd584-9eff-417a-a24b-8ce44fd0e946', 'H201232012', '昌平一号仓01', '019172a8-661f-4554-a496-133c9b987dea', 'WH1011001', '昌平一号仓', '9d0cd756-2ee5-4ea5-9405-07864f7c5b46', '好万运输', -69, 45, -5, 71, 100, 20, -1, 0, 2, 'null', 'null', '20190902151200', '2019-09-02 15:12:00');
...
-- ----------------------------
-- Table structure for cz_monitor
-- ----------------------------
DROP TABLE IF EXISTS `cz_monitor`;
CREATE TABLE `cz_monitor`  (
  `id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主键',
  `userName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '人员姓名',
  `userPhone` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '人员电话',
  `monitorState` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '预警类型，0：温湿度，1：温度，2：湿度',
  `hostId` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '预警的主机Id',
  `hostCode` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '预警的主机编码',
  `hostName` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '预警的主机名称',
  `createdTime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updateTime` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Records of cz_monitor
-- ----------------------------
INSERT INTO `cz_monitor` VALUES ('353c9a2d-9156-4b69-8d9f-503da556f9d8', '张三', '13111112222', '0', '45889eab-bcb2-4565-b974-cab3912d0622', 'H002123212', '昌平二号仓01', '2019-08-19 18:31:04', '2019-08-24 10:23:43');
INSERT INTO `cz_monitor` VALUES ('ed159a5a-f350-45c1-b84c-9ffe84c631b1', '李四', '13122112211', '0', '430d8aa7-94bc-4ceb-af69-2519a0cd2b3b', 'H100110003', '昌平一号仓03', '2019-07-25 17:19:52', '2019-08-24 10:23:48');
INSERT INTO `cz_monitor` VALUES ('f4810440-552f-4f07-96be-03ecf5e7dbf9', '王五', '13522221111', '2', 'aead6018-0fd1-48f7-a611-3a17a08496e1', 'H200230001', '朝阳二号仓01', '2019-07-25 16:36:27', '2019-08-24 10:23:55');
