<template>
  <div class="app-container">
    <div class="topLable">
      <div class="tit"><span><i class="icon">&#xe610;</i> 仓储报警记录</span> </div>
      <div class="info">
        <div class="butItem">
          <span class="label">编号</span>
          <el-input v-model="listQuery.number" @input="setNumber" size="mini" placeholder="请输入编号"></el-input>
        </div>
        <!--<div class="butItem">-->
...
import { getWarningList } from '@/api/log'
...
export default class extends Vue {
  ...
  private async getList() {
    ...
    const { data } = await getWarningList(this.listQuery)
